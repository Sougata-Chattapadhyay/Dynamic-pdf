...
<body>
    ...
    <div class="card">
        <h5 class="card-header">Create Template : </h5>
        <div class="card-body">
            <div class="htmlkey">
                <form method="POST" action="/create">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="tmp_name" rows="3"  name="tmp_name"/>
                    </div>
                    <div style="display: flex;">
                        <div id="addHtml" class="card">
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">Enter the html</label>
                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="html"></textarea>
                            </div>
